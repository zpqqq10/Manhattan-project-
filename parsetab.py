...
_lr_productions = [
  ...
  ('expressions -> expression','expressions',1,'p_statement_expr','interpreter.py',423),
  ('expressions -> expressions expression','expressions',2,'p_statement_expr','interpreter.py',424),
  ('expressions -> exp_exit','expressions',1,'p_statement_expr','interpreter.py',425),
  ('expression -> exp_select','expression',1,'p_expression_start','interpreter.py',432),
  ('expression -> exp_create_table','expression',1,'p_expression_start','interpreter.py',433),
  ('expression -> exp_create_index','expression',1,'p_expression_start','interpreter.py',434),
  ('expression -> exp_insert','expression',1,'p_expression_start','interpreter.py',435),
  ('expression -> exp_drop_table','expression',1,'p_expression_start','interpreter.py',436),
  ('expression -> exp_drop_index','expression',1,'p_expression_start','interpreter.py',437),
  ('expression -> exp_delete','expression',1,'p_expression_start','interpreter.py',438),
  ('expression -> exp_execfile','expression',1,'p_expression_start','interpreter.py',439),
  ('expression -> exp_help','expression',1,'p_expression_start','interpreter.py',440),
  ('expression -> exp_show','expression',1,'p_expression_start','interpreter.py',441),
  ('expression -> exp_update','expression',1,'p_expression_start','interpreter.py',442),
  ('exp_exit -> EXIT END','exp_exit',2,'p_expression_exit','interpreter.py',446),
  ('exp_update -> UPDATE COLUMN SET exp_assign END','exp_update',5,'p_expression_update','interpreter.py',452),
  ('exp_update -> UPDATE COLUMN SET exp_assign WHERE exp_condition END','exp_update',7,'p_expression_update','interpreter.py',453),
  ('exp_drop_table -> DROP TABLE COLUMN END','exp_drop_table',4,'p_expression_drop_table','interpreter.py',462),
  ('exp_assign -> COLUMN EQUAL COLUMN','exp_assign',3,'p_expression_assign','interpreter.py',471),
  ('exp_assign -> COLUMN EQUAL COLUMN COMMA exp_assign','exp_assign',5,'p_expression_assign','interpreter.py',472),
  ('exp_drop_index -> DROP INDEX COLUMN END','exp_drop_index',4,'p_expression_drop_index','interpreter.py',476),
  ('exp_delete -> DELETE FROM COLUMN END','exp_delete',4,'p_expression_delete','interpreter.py',486),
  ('exp_delete -> DELETE FROM COLUMN WHERE exp_condition END','exp_delete',6,'p_expression_delete','interpreter.py',487),
  ('exp_select -> SELECT columns FROM COLUMN END','exp_select',5,'p_expression_select','interpreter.py',499),
  ('exp_select -> SELECT STAR FROM COLUMN END','exp_select',5,'p_expression_select','interpreter.py',500),
  ('exp_select -> SELECT STAR FROM COLUMN WHERE exp_condition END','exp_select',7,'p_expression_select','interpreter.py',501),
  ('exp_select -> SELECT columns FROM COLUMN WHERE exp_condition END','exp_select',7,'p_expression_select','interpreter.py',502),
  ('exp_create_table -> CREATE TABLE COLUMN LFPARENTH exp_attributes COMMA PRIMARY KEY LFPARENTH COLUMN RGPARENTH RGPARENTH END','exp_create_table',13,'p_expression_create_table','interpreter.py',516),
  ('exp_create_index -> CREATE INDEX COLUMN ON COLUMN LFPARENTH COLUMN RGPARENTH END','exp_create_index',9,'p_expression_create_index','interpreter.py',532),
  ('exp_attributes -> exp_attribute','exp_attributes',1,'p_expression_attributes','interpreter.py',556),
  ('exp_attributes -> exp_attributes COMMA exp_attribute','exp_attributes',3,'p_expression_attributes','interpreter.py',557),
  ('exp_attribute -> COLUMN TYPE','exp_attribute',2,'p_expression_attribute','interpreter.py',561),
  ('exp_attribute -> COLUMN CHAR LFPARENTH COLUMN RGPARENTH','exp_attribute',5,'p_expression_attribute','interpreter.py',562),
  ('exp_attribute -> COLUMN TYPE UNIQUE','exp_attribute',3,'p_expression_attribute','interpreter.py',563),
  ('exp_attribute -> COLUMN CHAR LFPARENTH COLUMN RGPARENTH UNIQUE','exp_attribute',6,'p_expression_attribute','interpreter.py',564),
  ('exp_insert -> INSERT INTO COLUMN exp_insert_end','exp_insert',4,'p_expression_insert','interpreter.py',577),
  ('exp_condition -> COLUMN OP COLUMN','exp_condition',3,'p_expression_condition','interpreter.py',589),
  ('exp_condition -> COLUMN OP COLUMN AND exp_condition','exp_condition',5,'p_expression_condition','interpreter.py',590),
  ('exp_condition -> COLUMN EQUAL COLUMN','exp_condition',3,'p_expression_condition','interpreter.py',591),
  ('exp_condition -> COLUMN EQUAL COLUMN AND exp_condition','exp_condition',5,'p_expression_condition','interpreter.py',592),
  ('exp_insert_end -> VALUES LFPARENTH columns RGPARENTH END','exp_insert_end',5,'p_expresssion_insert_end','interpreter.py',598),
  ('exp_insert_end -> LFPARENTH columns RGPARENTH VALUES LFPARENTH columns RGPARENTH END','exp_insert_end',8,'p_expresssion_insert_end','interpreter.py',599),
  ('columns -> COLUMN','columns',1,'p_expression_columns','interpreter.py',605),
  ('columns -> COLUMN COMMA columns','columns',3,'p_expression_columns','interpreter.py',606),
  ('exp_show -> SHOW END','exp_show',2,'p_expression_show','interpreter.py',611),
  ('exp_execfile -> EXECFILE COLUMN END','exp_execfile',3,'p_expression_execfile','interpreter.py',616),
  ('exp_help -> HELP END','exp_help',2,'p_expression_help','interpreter.py',621),
]
